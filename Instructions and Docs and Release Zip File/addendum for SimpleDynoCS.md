...
- Directory for setting files is moved to `C:\Users\your_dir\AppData\Roaming\SimpleDyno"` as default location. The path is gotten by using APIs so it may vary with your configuration. We no longer use "Program Files" folder for such purpose.
